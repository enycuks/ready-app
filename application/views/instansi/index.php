                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <h4 class="sub-title">Data Instansi</h4>
                                    <a href="<?= base_url() ?>instansi/add" class="btn btn-info btn-sm"> Tambah </a><br>
                                    <br>
                                    <?php if ($this->session->flashdata('flash')) : ?> <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            Selamat <strong>Instansi</strong> <?= $this->session->flashdata('flash'); ?>.
                                        </div>
                                    <?php endif; ?>
                                    <br>
